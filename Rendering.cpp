...
void Rendering::initImgui()
{
    ...
    */
    ...
    //TODO: add these to the cleanup/shutdown
...
void Rendering::mainLoop() {
    ...
    windowState["showContentBrowser"] = true;
    windowState["showInspector"] = true;

    //ImGui vairable state setup
    bool isQuestConnected = false;

    ImVec4 clear_color = ImVec4(0.45f, 0.55f, 0.60f, 1.00f);


    while (!glfwWindowShouldClose(window) && windowState["applicationOpen"]) {
        glfwPollEvents();
        ...
        windowState = EngineUI(windowState);
